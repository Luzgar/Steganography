...
public class DirectWayTest {
    ...
    public void testBrowse() throws Exception {
        image.LSB(msg.getBytes(),magic,8,chan, Ways.DIRECT,null);
        assertTrue(image.getImage().equals(new ImageMatrix("test/direct.png").getImage()));
    ...
    public void testSizeException() throws ImageTooShort, ChannelException {
        image.LSB(new File("secret.txt").toString().getBytes(),magic,1,chan,Ways.DIRECT,null);
    }
    ...
    public void testchannel() throws ImageTooShort, ChannelException, IOException {
        ...
        imageMatrix.LSB(msg.getBytes(),magic,8,new Channels[]{Channels.ALPHA},Ways.DIRECT,null);
    }
}