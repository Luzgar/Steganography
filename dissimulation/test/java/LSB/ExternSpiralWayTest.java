 ...
 */
public class ExternSpiralWayTest {
    ImageMatrix image;
    String msg;
    String magic;
    Channels[] chan;
    ...
    public void testBrowse() throws Exception {
        image.LSB(msg.getBytes(),magic,8,chan, Ways.EXTSPI,null);
        assertTrue(image.getImage().equals(new ImageMatrix("test/extern.png").getImage()));
    ...
    public void testSizeException() throws ImageTooShort, ChannelException {
        image.LSB(new File("secret.txt").toString().getBytes(),magic,1,chan,Ways.EXTSPI,null);
    }
    ...
    public void testchannel() throws ImageTooShort, ChannelException, IOException {
        ...
        imageMatrix.LSB(msg.getBytes(),magic,8,new Channels[]{Channels.ALPHA},Ways.EXTSPI,null);
    }
